...
module.exports = class OfferRoutes extends ParentRoute {
  ...
  constructor() {
    ...
    swaggerBuilder.addRoute('/api/v1/offer', 'post', 'Create a new offer', ['Offer'])
      .addFormField('nightlyPrice', 'string', 'the nightlyPrice of offer', false)
    ...
    swaggerBuilder.addRoute('/api/v1/offer', 'get', 'Get list of offer', ['Offer'])
      ...
      .addQueryParam('nightlyPrice', 'number', 'the nightlyPrice of offer', false)
      .addQueryParam('nightlyPriceLessThan', 'number', 'the nightlyPriceLessThan of offer', false)
      .addQueryParam('nightlyPriceLessThanOrEqualTo', 'number', 'the nightlyPriceLessThanOrEqualTo of offer', false)
      .addQueryParam('nightlyPriceGreaterThanOrEqualTo', 'number', 'the nightlyPriceGreaterThanOrEqualTo of offer', false)
      .addQueryParam('nightlyPriceGreaterThan', 'number', 'the nightlyPriceGreaterThan of offer', false)
