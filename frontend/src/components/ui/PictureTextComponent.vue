<template>
  <div class="picture-text-container h-auto md:h-[85vh] flex flex-col md:flex-row justify-between items-center">
    <div class="picture-section h-[50vh] md:h-full w-full md:w-[48%] overflow-hidden">
